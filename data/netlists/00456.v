// Benchmark "magnitude_comparator_4bit" written by ABC on Wed Jun 26 15:22:11 2024
...
module magnitude_comparator_4bit ( 
  ...
  NOR2X1   g14(.A(new_n25), .B(new_n18), .Y(new_n26));
  AOI22X1  g15(.A0(new_n26), .A1(new_n14), .B0(new_n24), .B1(new_n20), .Y(new_n27));
  ...
  OR4X1    g24(.A(new_n35), .B(new_n33), .C(new_n31), .D(new_n29), .Y(new_n36));
  NOR2X1   g25(.A(new_n36), .B(new_n27), .Y(EQ));
  NOR4X1   g26(.A(new_n35), .B(new_n33), .C(new_n31), .D(new_n29), .Y(new_n38));
  AOI22X1  g27(.A0(new_n26), .A1(new_n14), .B0(new_n24), .B1(new_n20), .Y(GT));
  NOR2X1   g28(.A(new_n38), .B(new_n27), .Y(LT));
endmodule
