...
/* Instantiate wires for transceiver clocks and data */
wire xcvr_tx_clk;
wire xcvr_rx_clk;
...
/* Instantiate wires for PHY clocks and data */
wire [1:0] phy_tx_hdr;
wire [63:0] phy_tx_data;
wire [1:0] phy_rx_hdr;
wire [63:0] phy_rx_data;

/* Connect clocks and data between transceiver and PHY */
...
/* Instantiate Ethernet transceiver module */
...
/* Instantiate sync_reset modules for PHY reset signals */
sync_reset #(
    .N(4)
)
...
/* Instantiate Ethernet PHY module */
eth_phy_10g #(
    .BIT_REVERSE(0),
