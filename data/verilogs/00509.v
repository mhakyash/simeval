   ...
   initial
     begin
        ...
        casex ( done )
           ...
           1'b1: begin
                   a_fifo_cam_indices[3] = lt_fifo_cam_indices[2];
                   a_fifo_cam_indices[2] = lt_fifo_cam_indices[1];
                   a_fifo_cam_indices[1] = lt_fifo_cam_indices[0];
                   a_fifo_cam_indices[0] = 3'b000;
                 end
           1'b0: begin
                   a_fifo_cam_indices[3] = lt_fifo_cam_indices[3];
                   a_fifo_cam_indices[2] = lt_fifo_cam_indices[2];
                   a_fifo_cam_indices[1] = lt_fifo_cam_indices[1];
                   a_fifo_cam_indices[0] = lt_fifo_cam_indices[0];
                 end
        endcase
