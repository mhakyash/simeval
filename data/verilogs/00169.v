module Clk_Wizard_Clk_Wizard_clk_wiz
  ...
  LUT1 #(
    ...
    mmcm_adv_inst_i_1
       (.I0(resetn),
        .O(reset_high));
  assign Clock_Board_Clk_Wizard = Clock_Board_ibuf;
  assign VGA_clock_Clk_Wizard = mmcm_adv_inst.CLKOUT0;
  assign Main_clock_Clk_Wizard = mmcm_adv_inst.CLKOUT1;
endmodule